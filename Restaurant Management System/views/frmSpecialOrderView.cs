...
{
    public partial class frmSpecialOrderView : Form
    {
        public frmSpecialOrderView()
        {
            InitializeComponent();
        }
        ...
        {
            frmPOSSpecialOrder frm = new frmPOSSpecialOrder();
            frm.ShowDialog();
        }
        ...
        private void btnAddSpecialOrderr_Click(object sender, EventArgs e)
        {
        ...
        private void GetOrders()
        {
            ...
            string qry1 = @"select * from tblMain_tbl where status = 'Pending' and isSpecial = 1";
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                string qry2 = @"select * from tblMain_tbl m
                                ...
                                where m.MainID = '" + mid + "' and m.isSpecial = 1";
        ...
        private void frmSpecialOrderView_Load(object sender, EventArgs e)
        {
            GetOrders();
        }
    }
